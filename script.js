const SITE_URL = 'https://discomfortasacompass.vercel.app';
  ...
  if (navigator.share) {
    try {
      await navigator.share({
        title: 'Discomfort As a Compass — Sonic Remedy | Soozhee',
        text: 'Discomfort’s a compass, it’s leading you through. Let it shape you, free you, and make you new. By Soozhee.',
        url: SITE_URL
      });
      return;
    } catch (e) {}
